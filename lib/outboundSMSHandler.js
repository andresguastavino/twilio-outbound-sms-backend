...
const outboundSMSHandler = {
    createOutboundConversation: async ({ accountSid, authToken, res }) => {
        ...
        return buildResponse({ 
            ...
            error, 
            statusCodeIfOk: 201, 
            message: 'Outbound SMS conversation created succesfully' 
        });
    }
}
    ...
    return await client.flexApi.v1.channel
        .create({
            ...
            taskAttributes: JSON.stringify({
                ...
                name: to,
                from: from,
                targetWorker: 'client:andres_2Eguastavino_40ollierentals_2Ecom',
                autoAnswer: 'true'
            }),
            identity: `sms_${ to }`,
